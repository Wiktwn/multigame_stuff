...
def start():
    global pressed, must_continue, turn, piece_poses, selected_key
...
# no reset function included

def entrypoint():
    initialize()
    start()
    # this will return execution to whatever location it was called from, so if we call it from the multigame module and return from within here, we resume execution in the multigame module